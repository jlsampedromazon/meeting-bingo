/**
 * Persistent banner shown when the Web Speech API is unavailable (e.g. Firefox).
...
export function UnsupportedBanner() {
  return (
    ...
    >
      Speech recognition isn&rsquo;t available in this browser — tap squares manually to play.
    </div>
  )
}
